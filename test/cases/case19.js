export const title       = '19) options="g-script: true"';
export const description = `show g-script instead of script`;
...
<g-editor href="grapper-view" options="g-script: true"></g-editor>
`;