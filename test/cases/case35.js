export const title       = '35) editor mode="editor"';
export const description = `displays the code and the exit button is hidden`;
...
<g-editor href="grapper-view" title="editor mode" mode="editor"></g-editor>
`;